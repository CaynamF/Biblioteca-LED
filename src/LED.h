...
class Led
{
    ...
    public:
         ...
         * @param tempoLigado_ms Tempo, em milissegundos, que o LED fica ligado.
         */
        ...
        /**
         * @brief Pisca o LED em uma frequencia determinada.
        ...
        /**
         * @brief Verifica as atualizações do código.
         */
        void update();
};
#endif